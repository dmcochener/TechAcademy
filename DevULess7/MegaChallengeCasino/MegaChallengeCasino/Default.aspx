...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Image ID="oneResultImage" runat="server" Height="150px" Width="150px" />
&nbsp;
            <asp:Image ID="twoResultImage" runat="server" Height="150px" Width="150px" />
&nbsp;
            <asp:Image ID="threeResultImage" runat="server" Height="150px" Width="150px" />
            <br />
            <br />
            Your Bet: <asp:TextBox ID="betAmountTextBox" runat="server"></asp:TextBox>
            <br />
            <br />
